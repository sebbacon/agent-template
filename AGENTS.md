...
* When adding code, run `just coverage` to check the coverage. Always aim to have 100% coverage. Sometimes this doesn't add value to the code, if you're finding it hard to get that last 1%, you can use pragma to skip coverage of specific lines
